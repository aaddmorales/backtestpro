# ============================================================
#  BotTested API — v6.21  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
