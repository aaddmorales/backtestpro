# ============================================================
#  BotTested API — v7.02  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
