# ============================================================
#  BotTested API — v7.37  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-08-05e-stop-do-envio-b | Deploy: Railway
        ...
        try:
            ...
            if not texto or "BT_EVT_V2" not in texto or "BT_DISCIPLINA_V3" not in texto or "BT_OTT_V1" not in texto:
                esqueleto = (
                    ...
                    "         double sl=(InpStopLoss>0)?(ask-InpStopLoss):0.0;\n"
                    ...
                    "         double sl=(InpStopLoss>0)?(bid+InpStopLoss):0.0;\n"
