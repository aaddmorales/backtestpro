...
public:
   ...
   {
      Print("BOTTESTED_EVENTO|aberto|tipo=aberto|simbolo=", _Symbol, "|lado=", lado,
   ...
   {
      Print("BOTTESTED_EVENTO|rejeitado|tipo=rejeitado|simbolo=", _Symbol, "|lado=", lado,
   ...
   bool PositionClose(const string symbol, const ulong deviation=ULONG_MAX)
   {
      ...
      if(ok) Print("BOTTESTED_EVENTO|fechado|tipo=fechado|simbolo=", _Symbol,
                   "|preco=", DoubleToString(ResultPrice(), _Digits),
                   "|ticket=", IntegerToString((long)ResultOrder()));
      return ok;
   }
