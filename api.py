# ============================================================
#  BotTested API — v6.98  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-23a-babymachine-medicao-integra | Deploy: Railway
