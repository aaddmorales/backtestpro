# ============================================================
#  BotTested API — v7.17  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-26f-refundacao-biblioteca | Deploy: Railway
