# ============================================================
#  BotTested API — v6.84  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-19i-sanidade-v2 | Deploy: Railway
