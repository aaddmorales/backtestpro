# ============================================================
#  BotTested API — v7.14  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-26b-vitrine-timeframe | Deploy: Railway
...
def _vit_estrelas(sh_max, bons, n, min_trades_ok):
    ...
    if sh_max >= 2.5 and bons == n and n >= 3:
        e = 5
...
def _vit_escada_tf(combos, min_trades):
    ...
    for tf, d in porf.items():
        ...
        linhas.append({
            "tf": tf,
            "estrelas": _vit_estrelas(sh_max, d["bons"], d["n"], d["trades"] >= min_trades),
