# ============================================================
#  BotTested API — v6.85  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-19j-fix-escape-template | Deploy: Railway
