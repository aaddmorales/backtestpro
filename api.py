# ============================================================
#  BotTested API — v6.83  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-19h-codigos-reprovacao | Deploy: Railway
...
def _mq5_sanidade(texto):
    """SENTINELA: string MQL5 não atravessa linha — aspas abertas sem fechar na
    mesma linha = código corrompido (assinatura do cache envenenado / error
    112). Respeita \" escapado, // comentário e char literal tipo '"'.
        ...
        for num, linha in enumerate(str(texto or "").split("\n"), 1):
            ...
            while i < n:
                ...
                if dentro:
                    ...
                    break   # comentário: aspas soltas em // não contam
                elif ch == "'":
