# ============================================================
#  BotTested API — v7.09  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-23d-plano-da-entrada | Deploy: Railway
...
def _checklist_entrada(direcao=None, scanner=None, extras=None, candles_op=None,
        ...
        if not alvo:
            ...
            if isinstance(contra, list) and atr > 0:
                ...
                if dists:
                    ...
                    ok4, det4 = True, "sem nivel contrario mapeado no caminho"
    ...
    try:
        ...
        pass
    itens.append({"id": "rr", "nome": "Risco:Retorno 1:2+", "ok": ok5, "detalhe": det5})
    ...
    try:
        ...
        pass
    itens.append({"id": "ia", "nome": "Leitura da IA favoravel", "ok": ok7, "detalhe": det7})
