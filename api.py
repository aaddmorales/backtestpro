# ============================================================
#  BotTested API — v7.32  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-08-04a-ciclo-circular-v1 | Deploy: Railway
...
def _protetor_posicao(sb, bot, snap, det):
    ...
    abertas = []
    try:
        r = (sb.table("babymachine_operacoes").select("id,decisao")
