# ============================================================
#  BotTested API — v6.68  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-18a-candles-reais | Deploy: Railway
