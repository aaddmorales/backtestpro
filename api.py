# ============================================================
#  BotTested API — v7.35  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-08-05c-stop-estrutural | Deploy: Railway
            ...
            if _atr0 > 0:
                ...
                for a in abertas:
                    ...
                    if not a.get("lado") or a.get("idade_s") is None or a["idade_s"] > 900:
                        continue
                    if a.get("sl") is None or not a.get("ticket"):
                        continue
