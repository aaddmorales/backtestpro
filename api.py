...
function radarSugestaoBox(ap){
  ...
  div.innerHTML = `🎯 <b>Quer testar essa configuração?</b><br>${partes.join(' · ')}
    <div style="display:flex;gap:7px;margin-top:9px">
      <button class="radar-act radar-btn-aplicar">✅ Aplicar</button>
      <button class="radar-act radar-btn-rodar" style="border-color:rgba(0,208,132,0.5);color:var(--green)">▶ Aplicar e rodar</button>
    </div>`;
  // sugestão fica guardada no objeto JS — nada de serializar em atributo HTML
  div.querySelector('.radar-btn-aplicar').addEventListener('click', () => aplicarSugestaoRadar(ap, false));
