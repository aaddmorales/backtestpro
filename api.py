# ============================================================
#  BotTested API — v7.34  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-08-05b-maquina-de-fases | Deploy: Railway
