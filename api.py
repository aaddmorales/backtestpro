# ============================================================
#  BotTested API — v7.11  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-25f-prob-execucao | Deploy: Railway
