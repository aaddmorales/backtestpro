# ============================================================
#  BotTested API — v6.17  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
...
def usuario_progresso(user_id: str = "", bot_token: str = ""):
