# ============================================================
#  BotTested API — v7.39  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-08-06a-veto-de-fase | Deploy: Railway
