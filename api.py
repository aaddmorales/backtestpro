# ============================================================
#  BotTested API — v7.04  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
...
def _checklist_entrada(direcao=None, scanner=None, extras=None, candles_op=None,
    ...
    try:
        cs = candles_op or []
        vols = [float(c.get("v") or 0) for c in cs if isinstance(c, dict)]
