# ============================================================
#  BotTested API — v7.23  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-27a-vitrine-curada | Deploy: Railway
...
def _checklist_entrada(direcao=None, scanner=None, extras=None, candles_op=None,
    ...
    itens.append({"id": "tendencia", "nome": "Tendencia confirmada", "ok": ok2, "detalhe": det2,
                  "pct": pct2})
