# ============================================================
#  BotTested API — v7.33  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-08-05a-guardiao-aderencia | Deploy: Railway
