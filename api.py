...
#  Build: 2026-08-09b-bt-niveis-v1 | Deploy: Railway
    ...
    try:
        ...
        try:
            ...
            if _ult and _ult[0] == direcao and (_ag - _ult[1]) < 30:
                ...
                return
            _BM_ULT_ABERTURA[bot.get("id")] = (direcao, _ag)
        except Exception:
            pass
        ...
        try:
            ...
            for r0 in rec:
                if str(((r0.get("decisao") or {}).get("direcao")) or "") == direcao:
