# ============================================================
#  BotTested API — v6.43  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
#  Build: 2026-07-12n-vitrine-em-medicao | Deploy: Railway
