# ============================================================
#  BotTested API — v6.80  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-19e-swing-patterns | Deploy: Railway
...
def _bot_assinatura(fatos):
    ...
    return f"{reg}|{pos}|{pad}|{mom}|{pos_range_b}|{rng}|{sw}"
