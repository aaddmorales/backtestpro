# ============================================================
#  BotTested API — v7.16  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-26e-dedup-raiz | Deploy: Railway
