# ============================================================
#  BotTested API — v6.62  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
#  Build: 2026-07-15b-fix-literal-visao | Deploy: Railway
