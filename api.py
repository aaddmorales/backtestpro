# ============================================================
#  BotTested API — v6.61  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
#  Build: 2026-07-15a-olho-vivo-ficha | Deploy: Railway
