# ============================================================
#  BotTested API — v7.05  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
        ...
        try:
            ...
            if _sbp is not None:
                ...
                if _row.data:
                    ...
                    _cfgp["pausado"] = bool(novo["pausado"])
