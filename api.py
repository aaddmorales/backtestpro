# ============================================================
#  BotTested API — v6.58  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
#  Build: 2026-07-14e-visao-no-envio | Deploy: Railway
