# ============================================================
#  BotTested API — v6.16  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 604, e no /versao)
...
def usuario_progresso(user_id: str = ""):
    ...
    · 4 Enviar (registrou bot) · 5 Conectar (bot já pingou) · 6 Operar (bot com posição/snap).
    ...
    try:
        ...
        rb = (sb.table("conector_bots").select("*")
        ...
        if bots:
            ...
            for b in bots:
                if b.get("ultimo_ping"):
                    etapa = max(etapa, 5)  # conector já pingou = conectou
                if (b.get("posicoes_abertas") or 0) > 0:
                    etapa = max(etapa, 6)  # bot com posição aberta = operando
    except Exception:
        pass
