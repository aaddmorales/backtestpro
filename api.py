# ============================================================
#  BotTested API — v6.93  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-19r-ia-diagnostico-na-tela | Deploy: Railway
...
def _anl_ler_leitura(sb, user_id, bot_id):
    ...
    try:
        ...
        return {
            ...
            "entradas_hoje": (ent_por_nome.get(b.get("nome"))
                              if b.get("nome") in ent_por_nome
                              else ent_por_simbolo.get(str(s.get("simbolo") or b.get("simbolo") or "").upper(), 0)),
