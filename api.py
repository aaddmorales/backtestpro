# ============================================================
#  BotTested API — v6.71  (a versão REAL está em API_VERSAO/BUILD_TAG, ~linha 640, e no /versao)
#  Build: 2026-07-18d-bot-le-offmind | Deploy: Railway
...
BUILD_TAG = "2026-07-18d-bot-le-offmind"
...
string BTvCandles(ENUM_TIMEFRAMES tf, int qtd)
{
   ...
   {
      if(i < cop - 1) out += ";";
      out += BTvD(rates[i].open) + "," + BTvD(rates[i].high) + "," + BTvD(rates[i].low) + "," + BTvD(rates[i].close);
   }
   return out;
}
